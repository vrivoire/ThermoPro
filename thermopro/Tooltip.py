...
class Tooltip:
    ...
    def get_matrix(self, temp: int, humidity: int):
        ...
        if temp < 21 or temp > 43 or humidity < 20:
            return ('black', '')
        ...
        print(temp, humidity, temp - 20, h, matrix.iat[h, temp - 20], COMFORT_MATRIX_LABELS.get(matrix.iat[h, temp - 20]))
        return (matrix.iat[h, temp - 20], COMFORT_MATRIX_LABELS.get(matrix.iat[h, temp - 20]))
